  ...
  return (
    <div className="container">
      <form onSubmit={sendEmail} id="template_xmsmsvv" style={{ display: "block", paddingTop: 10, paddingLeft: 25, textAlign: "left" }}>
        ...
        <label>Name</label> <br />
        <input style={{ display: "block", width: 500, lineHeight: 2 }} type="text" name="from_name" /> <br />
        <label>Email</label> <br />
        <input style={{ display: "block", width: 500, lineHeight: 2 }} type="email" name="to_email" /> <br />
        <label>Message</label> <br />
        <textarea style={{ display: "block", width: 500, lineHeight: 4 }} name="message" /> <br />
